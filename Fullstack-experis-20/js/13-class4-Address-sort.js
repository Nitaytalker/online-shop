...
const entries = Object.entries(averagesByCities);

function byAvgDesc(city1, city2) {
    return city2[1] - city1[1];
}

entries.sort(byAvgDesc);

for(const city of entries){
    console.log(`CITY ${city[0]} -> AVG ${city[1]}`);
}
