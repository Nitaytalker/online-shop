...
class Student {
    constructor(id, name, courses, avg, address, pic) {
        this.id = id;
        this.name = name;
...
const myStudent = [
    ...
    new Student(2, 'Neta', ['JS', 'React', 'Node'], 65, new Address('Jerusalem', 'Tzi Moshe 4', 5252), "https://cdn.now.howstuffworks.com/media-content/0b7f4e9b-f59c-4024-9f06-b3dc12850ab7-1920-1080.jpg"),
    new Student(3, 'Ohad', ['JS', 'React'], 75, new Address('Beer Sheva', 'Ben Gurion 120', 9999), "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRlUBAsQUqu5a6Ce5GLi_dUqdjA2P7wE0-o8A&usqp=CAU"),
    new Student(4, 'Amit', ['JS', 'React'], 65, new Address('Dimona', 'Lev 10', 121212), "https://www.branza.co.il/assets/uploads/articles/horizontal_big/1de6268ac1465a9bb9953180bfc97696.jpg"),
    new Student(5, 'Saja', ['JS', 'React'], 100, new Address('Mitzpe', 'Moshe 40', 121212), "https://cdn.now.howstuffworks.com/media-content/f94d2646-9628-45ae-b69d-a0d317dc37e5-1920-1080.jpg")
];
